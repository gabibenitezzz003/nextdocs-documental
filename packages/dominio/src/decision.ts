...
export const TRANSICIONES: Record<EstadoDocumento, EstadoDocumento[]> = {
  RECIBIDO: ['PROCESANDO', 'RECHAZADO', 'ELIMINADO'],
  PROCESANDO: ['EXTRAIDO', 'OBSERVADO', 'RECHAZADO', 'DIVIDIDO', 'ELIMINADO'],
  EXTRAIDO: ['VALIDADO', 'OBSERVADO', 'RECHAZADO', 'ELIMINADO'],
  VALIDADO: ['APROBADO', 'OBSERVADO', 'RECHAZADO', 'ELIMINADO'],
  OBSERVADO: ['PROCESANDO', 'VALIDADO', 'APROBADO', 'RECHAZADO', 'ELIMINADO'],
  APROBADO: ['CERRADO', 'ELIMINADO'],
  RECHAZADO: ['ELIMINADO'],
  CERRADO: ['ELIMINADO'],
  DIVIDIDO: ['RECHAZADO', 'ELIMINADO'],
  ELIMINADO: [],
};
